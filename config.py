...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7568177214:AAHRi1fg2Yiduv46IK70AJBmxm4Og9spQwQ")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002264216992"))
...
#start message
START_PIC = os.environ.get("START_PIC","https://envs.sh/zgj.jpg")
...
#Force sub message 
FORCE_PIC = os.environ.get("FORCE_PIC", "https://envs.sh/zgL.jpg")
